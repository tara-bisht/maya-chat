...
export const UserTurn: React.FC<UserTurnProps> = ({
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'flex-start', maxWidth: 650, ...style }}>
...
export const AgentTurn: React.FC<AgentTurnProps> = ({
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'flex-start', maxWidth: 720, ...style }}>
