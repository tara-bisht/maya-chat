...
export const HOUSE_AGENT_COLUMNS =
  "id, user_id, name, tagline, avatar_url, category, is_curated, is_host, is_public, free_tier, language_preset, tone_settings, tools_enabled, costume_id, archived_at" as const;
